...
import { trackPlatformSelected } from '../lib/analytics/taglyAnalytics.js';
    ...
    `;
        ...
        tab.addEventListener('click', () => {
            if (platform.isComingSoon) {
                ...
                if (toast && toastText) {
                    toastText.textContent = `Coming soon! Training our AI on ${platform.name} algorithm 🤫`;
            ...
            trackPlatformSelected(platform.id);
